...
<table class="table table-striped" id="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="javascript:void(0);" data-name="{{ $row->name }}" data-note="{{ $row->note }}" data-id="{{ $row->id }}" data-json="{{ $row->receipt }}" class="btn btn-xs btn-default display-receipt">收據資料</a>
